...
<Steps>
  <Step title="Upload your Lookup Table CSV">
    ...
    <Frame>
      ![image](/images/lexicon-lookup-table.png)
    </Frame>
  </Step>
  <Step title="Map the Lookup Table to an event or user profile property">
    ...
    <Frame>
      ![image](/images/lexicon-import-lookup-table.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title='Click the "..." button next to the breakdown property from your report and choose "Map Lookup Table"'>
    ...
    <Frame>
      ![image](/images/map-ephemeral-lookup-table.png)
    </Frame>
  </Step>
  <Step title="Select a Lookup Table to map to the breakdown property">
    ...
    <Frame>
      ![image](/images/create-ephemeral-lookup-table-modal.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![image](/images/lookup-table-properties.png)
</Frame>
...
<Frame>
  ![image](/images/lookup-table-insights.png)
</Frame>
...
<Frame>
  ![image](/images/lookup-table-id.png)
</Frame>
