...
<Frame className="bg-white">
  ![image](/images/tutorials/base-data-model.png)
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/8QgRNGqOl8A?rel=0" title="Data Model Overview" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
- mp\_original\_distinct\_id - event property used in [hot shard](/docs/debugging/distinct-id-limits#what-is-a-hot-shard) detection
...
<Frame className="bg-white">
  ![image](/images/tutorials/group-data-model.png)
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/yk-Y-VFItXE?rel=0" title="Group Analytics" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/UIfP56z2CY4?rel=0" title="Creating a Tracking Plan" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>

**_Link to [User Journey Figma](https://www.figma.com/file/tYEeeRE0Xz6IampBhGLotw/Media-and-Entertainment-Tracking-Plan?type=whiteboard&node-id=523-159&t=5GQDQsaqLeOTB8zU-4) shown in video._**
...
1. Prioritize on the key user journeys that are pertinent to the metrics and KPIs you want to measure.
   ...
   For example, a sign up journey will be important when measuring metrics related to newly acquired user _(part of Reach)_. If you used the [RAE Framework](/guides/strategic-playbooks/onboarding-playbook/plan/framework#the-rae-framework), make sure you cover the journeys that will help you track and measure your Reach, Activation, and Engagement.
...
2. Map the key actions within these journeys into events and capture event properties to provide additional information about the action. As you define your events, think about whether certain event properties should be global / super properties and user properties.
   ...
   <Frame className="bg-white">
     ![image](/images/tutorials/event-depth.png)
   </Frame>
...
**In general, we advise customers to group together the same _actions_ that users take across your site / platform, and group them to the level of the most commonly asked questions.**
...
3. As you map your events and properties, it's also important to ensure that you have factored [identifying users](/docs/tracking-methods/id-management/identifying-users) in your product _(eg website, app, devices)_.
