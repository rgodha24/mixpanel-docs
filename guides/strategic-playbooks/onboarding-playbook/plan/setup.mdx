...
- [Setup](/guides/strategic-playbooks/onboarding-playbook/plan/setup#setting-up-mixpanel) _(for Organization Owners and Admins)_ - takes you through how you should go about setting up your Mixpanel Organization and the underlying Projects.
- [Framework](/guides/strategic-playbooks/onboarding-playbook/plan/framework) - if you need guidance on defining your metrics and KPIs to help you achieve your business and product objectives, this tutorial should help you.
- [Tracking Strategy](/guides/strategic-playbooks/onboarding-playbook/plan/tracking-strategy) - this tutorial helps you understand Mixpanel's data model so you're equipped with building out your tracking plan to measure your metrics and KPIs.
...
3. Planning your users' **Data Access and Visibility** using Mixpanel's [Data Views & Classification](/docs/data-governance/data-views-and-classification) _(Enterprise Plan Only)_
...
<Frame>
  ![image](/images/tutorials/organization-discoverability.png)
</Frame>
...
<Frame>
  ![image](/images/tutorials/simplified-id-merge.png)
</Frame>
...
<Frame>
  ![image](/images/tutorials/create-projects.png)
</Frame>
...
2. Click **Create Project** to create each project
   ...
   - We recommend choosing **United States** as _Where To Store Your Data_ (unless you have [EU Residency](/docs/privacy/eu-residency) requirements)
...
<Frame>
  ![image](/images/tutorials/data-views-filter.png)
</Frame>
...
<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/E4C-eQgj2Zs?rel=0" title="How to Use Data Views" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![image](/images/mark-classified.png)
</Frame>

<Frame>
  ![image](/images/tutorials/can-view-classified.png)
</Frame>

<Frame>
  <iframe src="https://www.youtube-nocookie.com/embed/E4GHQ9v0POo?rel=0" title="Classified Data" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</Frame>
...
<Frame>
  ![image](/images/tutorials/user-access-approach.png)
</Frame>
...
<Frame>
  ![image](/images/tutorials/default-project-role.png)
</Frame>
